...
public class BezierView extends FrameLayout {
    ...
    private void init() {
        ...
        tipTextView.setBackgroundResource(R.mipmap.skin_tips_newmessage_ninetynine);
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 2:
                    tipTextView.setText("");
                    tipTextView.setBackgroundResource(R.mipmap.skin_tips_new);
                    break;
            }
        }
    };
